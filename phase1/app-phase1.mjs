...
function realisticFitPreview(storage, vehicle) {
  ...
  if (storage.type === "unit" && storage.sizeSqFt === 35) {
    examples.push({ id: "unit", tab: "35 sq ft unit", title: "Example 35 sq ft arrangement", image: "../assets/fit/unit-35-sq-ft.webp", alt: "Realistic example of furniture and moving boxes arranged inside a 35 square foot storage unit", copy: "Comparable to a carefully packed one-bedroom-home load, depending on item sizes and dismantling." });
  }
  if (vehicle.id === "lwb-transit") {
    examples.push({ id: "vehicle", tab: "LWB Transit", title: "Example LWB Transit load", image: "../assets/fit/vehicle-lwb-transit.webp", alt: "Realistic example of furniture and moving boxes safely arranged inside a long-wheelbase van", copy: "A representative carefully packed load—not a picture of your exact belongings." });
  }
