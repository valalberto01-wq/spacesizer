...
export const HOUSEHOLD_PRESETS = [
  ...
  { name: "Four-bedroom home", emoji: "🏡", description: "A substantial family home with four bedrooms, appliances and around 70 boxes.", items: [["King bed",1],["Double bed",2],["Single bed",1],["Wardrobe",4],["Chest of drawers",4],["Bedside table",6],["Three-seater sofa",1],["Two-seater sofa",1],["Armchair",2],["Coffee table",1],["TV",3],["TV unit",2],["Dining table",1],["Dining chair",8],["Fridge freezer",1],["Washing machine",1],["Dishwasher",1],["Bicycle",2],["Medium box",48],["Large box",22]] },
  { name: "Office move", emoji: "🖥️", description: "A small office with six workstations, filing and boxed records.", items: [["Desk",6],["Office chair",6],["Filing cabinet",4],["Computer monitor",8],["Medium box",24],["Large box",8]] },
  { name: "Warehouse or business stock", emoji: "🏭", description: "A flexible starting point for boxed stock, equipment and office furniture.", items: [["Desk",2],["Office chair",2],["Filing cabinet",2],["Tool box",4],["Medium box",40],["Large box",40]] }
];
